...
void WorldBackgroundRenderer::InitializeBackGroundGlContent()
{
...
void WorldBackgroundRenderer::Draw(const AREngine_ARSession *session, const AREngine_ARFrame *frame)
{
...
GLuint WorldBackgroundRenderer::GetTextureId() const { return textureId; }
