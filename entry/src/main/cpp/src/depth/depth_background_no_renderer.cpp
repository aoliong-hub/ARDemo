...
void DepthBackgroundNoRenderer::InitializeBackGroundGlContent()
{
...
void DepthBackgroundNoRenderer::Release()
{
    glDeleteTextures(1, &textureId);
    GLUtils::ReleaseProgram(shaderProgram);
}

void DepthBackgroundNoRenderer::Draw(const AREngine_ARSession *session, const AREngine_ARFrame *frame)
{
...
GLuint DepthBackgroundNoRenderer::GetTextureId() const { return textureId; }
