...
#ifndef MESH_BACKGROUND_RENDERER_H
#define MESH_BACKGROUND_RENDERER_H
...
class MeshBackgroundRenderer {
public:
    MeshBackgroundRenderer() = default;
    ~MeshBackgroundRenderer() = default;
     ...
     */
    void InitializeBackGroundGlContent(uint64_t width, uint64_t height);
