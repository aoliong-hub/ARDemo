...
void MeshObjectRenderer::InitializeObjectGlContent(const std::string &objFileName, const std::string &pngFileName)
{
...
void MeshObjectRenderer::Release()
{
    vertices.clear();
    normals.clear();
    uvs.clear();
...
void MeshObjectRenderer::Draw(const glm::mat4 &projectionMat, const glm::mat4 &viewMat, const glm::mat4 &modelMat,
