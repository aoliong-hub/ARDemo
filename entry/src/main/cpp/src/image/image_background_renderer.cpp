...
void ImageBackgroundRenderer::InitializeBackGroundGlContent()
{
...
void ImageBackgroundRenderer::Release()
{
    glDeleteTextures(1, &textureId);
    GLUtils::ReleaseProgram(shaderProgram);
}

void ImageBackgroundRenderer::Draw(const AREngine_ARSession *session, const AREngine_ARFrame *frame)
{
...
GLuint ImageBackgroundRenderer::GetTextureId() const { return textureId; }
