...
#ifndef ARDEMO_IMAGE_BACKGROUND_RENDERER_H
#define ARDEMO_IMAGE_BACKGROUND_RENDERER_H
...
public:
    ImageBackgroundRenderer() = default;
    ~ImageBackgroundRenderer() = default;
...
#endif // ARDEMO_IMAGE_BACKGROUND_RENDERER_H
