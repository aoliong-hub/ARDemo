...
1. 相机权限：ohos.permission.CAMERA。
2. 加速度传感器权限：ohos.permission.ACCELEROMETER。
3. 陀螺仪传感器权限：ohos.permission.GYROSCOPE。
...
1. 本实例仅支持标准系统上运行，支持设备见下表。

| 设备类型 |产品系列|产品型号|
|----|--|--|
| 手机 |Mate系列|Mate 60, Mate 60 RS非凡大师, Mate 60 Pro, Mate 60 Pro+, <br>Mate 70, Mate 70 RS非凡大师, Mate 70 Pro, Mate 70 Pro+,<br> Mate X5, Mate X6, Mate XT非凡大师|
